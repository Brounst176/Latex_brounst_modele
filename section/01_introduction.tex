...
\section{ENCADRÉS PÉDAGOGIQUES}
\definition{Description d'un mot}
\aretenir{Elément important}
\exempleenc{Sample}
...
\reponseplaceautoheight{Avec seulement 99 permutations, la valeur pseudo-p est calculée sur peu de tirages aléatoires (p $\geq$  0.01 au minimum), ce qui laisse une marge d'erreur plus grande. Augmenter à 999 permutations affine l'estimation de la distribution nulle et permet de détecter les clusters réellement significatifs avec plus de confiance.}